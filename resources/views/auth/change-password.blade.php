...
<div class="w-full max-w-lg mx-auto bg-white rounded-3xl shadow-2xl p-10 border border-gray-200">
    <h2 class="text-3xl font-extrabold text-center text-gray-900 mb-10">Alterar Senha</h2>
    ...
    <form method="POST" action="{{ route('auth.change.password.update') }}" class="space-y-6">
        ...
        <div>
            <label class="block text-sm font-semibold text-gray-700 mb-2">Confirme a Nova Senha</label>
